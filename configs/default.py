...
# -----------------------------------------------------------------------------
_C.LCE = CN()
_C.LCE.USE_LCE = False
_C.LCE.TRAIN_HALF = False
_C.LCE.SAVE_LCEFEAT = False
_C.LCE.PATH_CCB = ''
_C.LCE.LAMBDA_A = 100
_C.LCE.LAMBDA_B = 1
_C.LCE.USE_TRANS = False
_C.LCE.FEATDIM_OLD = 2048
_C.LCE.FEATDIM_NEW = 2048
...
def update_config(config, args):
    ...
    # for LCE
    if args.train_half:
        config.LCE.TRAIN_HALF = True
    if args.save_lcefeat:
        config.LCE.SAVE_LCEFEAT = True
    if args.use_lce:
        config.LCE.USE_LCE = True
    if args.path_ccb:
        config.LCE.PATH_CCB = args.path_ccb
    if args.lambda_a:
        config.LCE.LAMBDA_A = args.lambda_a
    if args.lambda_b:
        config.LCE.LAMBDA_B = args.lambda_b
